...
public class Brugerdatabase implements Serializable {
	...
	public transient HashMap<String,Bruger> brugernavnTilBruger = new HashMap<String,Bruger>();
	...
	public static Brugerdatabase getInstans()
	{
		...
		try {
			...
			instans.brugernavnTilBruger = new HashMap<String,Bruger>();
			System.out.println("indl�ste serialiseret Brugerdatabase: "+instans);
		} catch (Exception e) {
